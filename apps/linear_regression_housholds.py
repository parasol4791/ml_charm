...
def predict_house_values(start, n, training_df, feature, label):
  """Predict house values based on a feature."""

  batch = training_df[feature][start:start + n]
  ...
  print("--------------------------------------")
  for i in range(n):
    print ("%5.2f %6.2f %15.2f" % (training_df[feature][start + i],
                                   training_df[label][start + i],
